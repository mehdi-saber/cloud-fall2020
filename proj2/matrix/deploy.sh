...
#ssh hadoopuser@192.168.56.106  'hdfs dfs -mkdir /user/hadoop/matrix/output &> /dev/null'
ssh hadoopuser@192.168.56.106  'hdfs dfs -rm -skipTrash -r /user/hadoop/input/ &> /dev/null'
ssh hadoopuser@192.168.56.106  'hdfs dfs -mkdir /user/hadoop/input/ &> /dev/null'
ssh hadoopuser@192.168.56.106  'hdfs dfs -copyFromLocal ~/test-mat/input/ /user/hadoop/input/'
ssh hadoopuser@192.168.56.106  'hadoop jar ~/test-mat/Matrix.jar Matrix /user/hadoop/input/input/test/ /user/hadoop/matrix/output'
